...
class Lead(db.Model):
    ...
    last_contact: Mapped[datetime] = mapped_column(DateTime,
                                                   default=datetime.utcnow)
    last_followup_email: Mapped[datetime] = mapped_column(DateTime,
                                                          nullable=True)
    last_followup_tracking_id: Mapped[str] = mapped_column(String(36),
                                                           nullable=True)
    last_email_opened: Mapped[datetime] = mapped_column(DateTime,
                                                        nullable=True)
