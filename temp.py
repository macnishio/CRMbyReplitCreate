...
def process_email_message(msg, settings, session, app, processed_ids=None):
    """
    Unified email processing with comprehensive duplicate detection and error handling
    """
    try:
